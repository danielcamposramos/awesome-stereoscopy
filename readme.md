...
The asymmetry here is the part worth noticing. Cinema 3D continued while consumer 3D was withdrawn: by 2016-2017 the last manufacturers had stopped building 3D televisions and broadcasters had closed their 3D channels, yet 3D screenings remained routine in multiplexes and still are. The explanation usually given is commercial rather than technical, since a cinema ticket, an IMAX screen or a theme-park attraction can carry a surcharge and a living room cannot. Whatever the reason, the effect on owners was the same: hardware that kept its panel and lost its ecosystem, which is why several entries in this list are about recovering formats rather than buying them.
